...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $sql = "UPDATE games SET " .
        ...
        ", gameavailnotes='" . $gameavailnotes . "'" .
        ", gamesystem='" .  $gamesystem . "'" .
        ", gamerules='" . $gamerulesstring .  "' " .
        ", gamestyle='" . $gamestylestring .  "' " .
        ", gamegenre='" . $gamegenrestring .  "' " .
        ", gametone='" . $gametone .  "' " .
        ", gameother='" . $gameotherstring .  "' " .
		", gameothernotes='" . $gameothernotes .  "' " .
